...
class Decision_maker_for_rnn(torch.nn.Module):
    def __init__(self):
        super(Decision_maker_for_rnn,self).__init__()
        self.fc1=nn.Linear(50*11+40, 200)
        self.fc2=nn.Sequential(nn.Linear(200, 4), nn.Sigmoid())
...
class full_rnn(nn.Module):
    def __init__(self, embedding_dim, vocab, hidden_dim):
        ...
        self.decision_net = Decision_maker_for_rnn()
